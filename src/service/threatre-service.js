...
/**
 * 
 * data -> object containing details of the theatre to be created
 * object with the new theatre details
 */
...
/**
 * 
 * id -> the unique id using which we can identify the theatre to be deleted
...
/**
 * 
 *  id -> it is the unique _id based on which we will fetch a theatre
 */
...
/**
 * 
 *  data -> the data to be used to filter out theatres based on city / pincode 
...
/**
 * 
 *  id -> the unique id to identify the theatre to be updated
 *  data -> data object to be used to update the theatre
...
/**
 * 
 * theatreId -> unique id of the theatre for which we want to update movies
 * movieIds -> array of movie ids that are expected to be updated in theatre
 * insert -> boolean that tells whether we want insert movies or remove them
